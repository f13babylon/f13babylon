...
//Bobstation ghost port - Alpha of ghost apperances copying the original path
#define GHOST_COPY_ALPHA 127
//Bobstation ghost port - Maximum motion blur a ghost can accumulate in the X or Y axis
