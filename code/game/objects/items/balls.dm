...
/obj/item/toy/tennis
	...
	icon = 'modular_fallout/icons/obj/balls.dmi'
	icon_state = "tennis_classic"
	lefthand_file = 'modular_fallout/icons/mob/inhands/balls_left.dmi'
	righthand_file = 'modular_fallout/icons/mob/inhands/balls_right.dmi'
	item_state = "tennis_classic"
	mob_overlay_icon = 'modular_fallout/icons/mob/mouthball.dmi'
