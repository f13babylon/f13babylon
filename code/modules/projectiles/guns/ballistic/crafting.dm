...
*/
// UZI //
/obj/item/gun/ballistic/automatic/smg/uzi/mid
	name = "enhanced uzi"
	fire_delay = 4
	extra_penetration = 0
	extra_damage = 0

/obj/item/gun/ballistic/automatic/smg/uzi/mid/enable_burst()
	. = ..()
	spread = 7.5

/obj/item/gun/ballistic/automatic/smg/uzi/mid/disable_burst()
	. = ..()
	spread = 0
/*
/obj/item/gun/ballistic/automatic/smg/uzi/mid/attackby(obj/item/W, mob/user, params)
	if(istype(W,/obj/item/screwdriver))
		var/obj/item/A = new /obj/item/prefabs/complex/screw
		var/obj/item/B = new /obj/item/prefabs/complex/trigger
		var/obj/item/C = new /obj/item/prefabs/complex/bolt/simple
	...
	. = ..()
*/
/obj/item/gun/ballistic/automatic/smg/uzi/high
	name = "advanced uzi"
	fire_delay = 3
	extra_damage = 5
	extra_penetration = 0.1

/obj/item/gun/ballistic/automatic/smg/uzi/high/enable_burst()
	. = ..()
	spread = 5

/obj/item/gun/ballistic/automatic/smg/uzi/high/disable_burst()
	. = ..()
	spread = 0
/*
/obj/item/gun/ballistic/automatic/smg/uzi/high/attackby(obj/item/W, mob/user, params)
	if(istype(W,/obj/item/screwdriver))
		var/obj/item/A = new /obj/item/prefabs/complex/screw
		var/obj/item/B = new /obj/item/prefabs/complex/trigger
		var/obj/item/C = new /obj/item/prefabs/complex/bolt/simple
	...
	. = ..()
*/
/obj/item/gun/ballistic/automatic/smg/uzi/burst_select()
