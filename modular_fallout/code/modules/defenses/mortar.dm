/obj/structure/mortar
	...
	icon = 'modular_fallout/icons/obj/structures/mortar.dmi'
...
*/
		...
		playsound(loc, 'modular_fallout/sound/defenses/mortar_reload.ogg', 50, 1)
		busy = 1
		...
		if(do_after(user, 15, src))
			...
			playsound(loc, 'modular_fallout/sound/defenses/mortar_fire.ogg', 50, 1)
			busy = 0
			firing = 1
			...
			spawn(travel_time) //What goes up
				playsound(T, 'modular_fallout/sound/defenses/mortar_long_whistle.ogg', 50, 1)
...
/obj/item/mortar_kit/attack_self(mob/user)
	...
	playsound(loc, 'modular_fallout/sound/defenses/mortar_unpack.ogg', 25, 1)
	if(do_after(user, 40, src))
