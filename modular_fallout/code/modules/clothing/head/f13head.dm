...
Just leaving this here for quick copy-pasting, for future contributors.
	icon = 'modular_fallout/icons/obj/clothing/hats.dmi'
	mob_overlay_icon = 'modular_fallout/icons/mob/clothing/head.dmi'
	anthro_mob_worn_overlay = 'modular_fallout/icons/mob/clothing/head_muzzled.dmi'
