...
/obj/item/clothing/suit/storage/trek/ds9
	...
	icon = 'modular_fallout/icons/obj/clothing/trek_item_icon.dmi'
	icon_state = "trek_ds9_coat"
	mob_overlay_icon = 'modular_fallout/icons/mob/clothing/trek_mob_icon.dmi'
...
/obj/item/clothing/suit/storage/trek/ds9/admiral // Only for adminuz
	...
	armor = list("melee" = 100, "bullet" = 100, "laser" = 100,"energy" = 50, "bomb" = 50, "bio" = 50, "rad" = 50, "fire" = 50, "acid" = 50)
