...
Just leaving this here for quick copy-pasting, for future contributors.
	icon = 'modular_fallout/icons/obj/clothing/masks.dmi'
	mob_overlay_icon = 'modular_fallout/icons/mob/clothing/mask.dmi'
	anthro_mob_worn_overlay = 'modular_fallout/icons/mob/clothing/mask_muzzled.dmi'
