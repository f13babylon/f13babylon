...
/obj/item/robot_module/k9
	...
	moduleselect_alternate_icon = 'modular_fallout/icons/ui/screen_cyborg.dmi'
	can_be_pushed = FALSE
	hat_offset = INFINITY
	sleeper_overlay = "ksleeper"
	cyborg_icon_override = 'modular_fallout/icons/mob/robot/widerobot_sec.dmi'
...
/obj/item/robot_module/k9/be_transformed_to(obj/item/robot_module/old_module)
	...
	if(!k9_models)
		k9_models = list(
			"K9" = image(icon = 'modular_fallout/icons/mob/robot/widerobot_sec.dmi', icon_state = "k9", pixel_x = -16),
			"Dark" = image(icon = 'modular_fallout/icons/mob/robot/widerobot_sec.dmi', icon_state = "k9dark", pixel_x = -16),
			"Vale" = image(icon = 'modular_fallout/icons/mob/robot/widerobot_sec.dmi', icon_state = "valesec", pixel_x = -16),
			"Drake" = image(icon = 'modular_fallout/icons/mob/robot/widerobot_sec.dmi', icon_state = "drakesec", pixel_x = -16)
		)
...
/obj/item/robot_module/medihound
	...
	cyborg_icon_override = 'modular_fallout/icons/mob/robot/widerobot_med.dmi'
	has_snowflake_deadsprite = TRUE
	dogborg = TRUE
	cyborg_pixel_offset = -16
...
/obj/item/robot_module/medihound/be_transformed_to(obj/item/robot_module/old_module)
	...
	if(!medihound_models)
		...
		"Medihound" = image(icon = 'modular_fallout/icons/mob/robot/widerobot_med.dmi', icon_state = "medihound", pixel_x = -16),
		"Dark" = image(icon = 'modular_fallout/icons/mob/robot/widerobot_med.dmi', icon_state = "medihounddark", pixel_x = -16),
		"Vale" = image(icon = 'modular_fallout/icons/mob/robot/widerobot_med.dmi', icon_state = "valemed", pixel_x = -16),
		"Drake" = image(icon = 'modular_fallout/icons/mob/robot/widerobot_med.dmi', icon_state = "drakemed", pixel_x = -16)
		)
...
/obj/item/robot_module/scrubpup
	...
	cyborg_icon_override = 'modular_fallout/icons/mob/robot/widerobot_jani.dmi'
	has_snowflake_deadsprite = TRUE
	dogborg = TRUE
	cyborg_pixel_offset = -16
...
/obj/item/robot_module/scrubpup/be_transformed_to(obj/item/robot_module/old_module)
	...
	if(!scrubpup_models)
		...
		"Scrubpup" = image(icon = 'modular_fallout/icons/mob/robot/widerobot_jani.dmi', icon_state = "scrubpup", pixel_x = -16),
		"Drake" = image(icon = 'modular_fallout/icons/mob/robot/widerobot_jani.dmi', icon_state = "drakejanit", pixel_x = -16),
		"J9" = image(icon = 'modular_fallout/icons/mob/robot/widerobot_jani.dmi', icon_state = "J9", pixel_x = -16)
		)
